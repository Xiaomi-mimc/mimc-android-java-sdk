...
public class QueryUnlimitedGroupMembersDialog extends Dialog {

    public QueryUnlimitedGroupMembersDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.query_unlimited_group_dialog);
        setCancelable(true);
        setTitle(R.string.query_unlimited_group);
        ...
        findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //UserManager.getInstance().getUser().queryUnlimitedGroupMembers(Long.parseLong(groupId));
                UserManager.getInstance().queryUnlimitedGroupMembers(Long.parseLong(groupId));
                dismiss();
            }
        });
    }
