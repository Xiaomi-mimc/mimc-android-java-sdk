...
public class QuitUnlimitedGroupDialog extends Dialog {

    public QuitUnlimitedGroupDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quit_unlimited_group_dialog);
        setCancelable(true);
        setTitle(R.string.quit_unlimited_group);
        ...
        findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserManager.getInstance().getMIMCUser().quitUnlimitedGroup(Long.parseLong(groupId), null);
                dismiss();
            }
        });
    }
