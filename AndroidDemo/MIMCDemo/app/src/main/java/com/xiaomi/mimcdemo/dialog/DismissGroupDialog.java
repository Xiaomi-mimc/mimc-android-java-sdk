...
public class DismissGroupDialog extends Dialog {

    public DismissGroupDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dismiss_group_dialog);
        setCancelable(true);
        setTitle(R.string.dismiss_group);
        ...
        findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserManager.getInstance().dismissGroup(groupId);
                dismiss();
            }
        });
    }
